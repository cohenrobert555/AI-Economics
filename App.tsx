    ...
    <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
      <Link to="/" className="flex items-center gap-3 group">
        ...
        <span className="text-2xl font-brand font-extrabold tracking-tighter text-white">
          AI<span className="text-indigo-400">ECONOMICS</span>
        </span>
      </Link>
    ...
    <div className="grid lg:grid-cols-[1fr_2.5fr] gap-20 items-start">
      <aside className="lg:sticky lg:top-48">
        ...
        <div className="mt-12 space-y-4">
           ...
           <a href="https://www.researchgate.net/profile/Robert-Cohen-25" target="_blank" rel="noopener noreferrer" className="block">
             <Button variant="outline" className="w-full text-[10px] bg-zinc-800 tracking-[0.2em]">ResearchGate Publications</Button>
           </a>
        </div>
      </aside>
  ...
  <section className="pt-48 pb-32 px-6 max-w-4xl mx-auto min-h-screen">
    ...
    <Card className="p-10 bg-zinc-900/60 border-white/5">
      <form className="space-y-6">
        ...
        <div className="space-y-2">
          <label className="text-[10px] font-black uppercase tracking-widest text-gray-500">Inquiry Brief</label>
      ...
      <div className="mt-8 pt-8 border-t border-white/5 text-center">
        <p className="text-gray-500 text-xs">Direct Correspondence: <a href="mailto:bcohen@bway.net" className="text-indigo-400 hover:text-indigo-300">bcohen@bway.net</a></p>
      </div>
    </Card>
  </section>
);
  ...
  <footer className="border-t border-white/5 py-20 mt-20 bg-zinc-950">
    <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-start gap-12">
      ...
      <div className="flex gap-16">
        <div>
          <h4 className="text-white font-black mb-6 uppercase text-[10px] tracking-widest text-indigo-500">Resources</h4>
          <ul className="space-y-4 text-gray-500 text-xs font-bold uppercase tracking-widest">
            <li><a href="https://www.researchgate.net/profile/Robert-Cohen-25" target="_blank" rel="noopener noreferrer" className="hover:text-white">ResearchGate</a></li>
            <li><a href="#" className="hover:text-white">Whitepapers</a></li>
          </ul>
        </div>
        <div>
          <h4 className="text-white font-black mb-6 uppercase text-[10px] tracking-widest text-indigo-500">Contact</h4>
          <ul className="space-y-4 text-gray-500 text-xs font-bold uppercase tracking-widest">
            <li><Link to="/contact" className="hover:text-white">Inquiry</Link></li>
            <li><a href="mailto:bcohen@bway.net" className="hover:text-white">Email</a></li>
          </ul>
        </div>
      </div>
    </div>
    <div className="max-w-7xl mx-auto px-6 mt-20 pt-8 border-t border-white/5 flex justify-between text-[10px] text-gray-600 font-bold uppercase tracking-widest">
      ...
      <span>Intelligence • Growth • Strategy</span>
    </div>
  </footer>
);
...
export default function App() {
  ...
  const [state, setState] = useState<AppState>(() => {
    ...
    return saved ? JSON.parse(saved) : { config: DEFAULT_CONFIG, profile: INITIAL_PROFILE };
  });
